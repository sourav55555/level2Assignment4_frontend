      ...
      <main className="bg-primary text-white">
        ...
        <div>
          <div className="h-auto relative">
            ...
            <div className="h-full w-full z-10 absolute top-0 right-0 flex items-center justify-center">
              <div className="text-white text-center max-w-3xl">
                <h1 className="text-7xl  md:text-9xl font-light mb-4 ">Craving Something Delicious?</h1>
          ...
          <div className="py-20 mx-auto px-4 max-w-328">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-5 md:gap-20 mt-12">
              <div>
                <Link href="/" className="relative">
                  ...
                  <div className=" group overflow-hidden rounded-t-full">
                      ...
                      <Image src={cat1} className="h-52 md:h-100 ease-in-out group-hover:scale-105  transition-all duration-300 object-cover rounded-t-full" alt="Appetizers" />
                    </div>
                  </Link>
                <Link href="/" className="text-center mt-4 space-y-2 md:space-y-3 px-1.5 md:px-8 block">
                  <p className=" text-2xl md:text-3xl mt-6">Starters</p>
              ...
              <div>
                <Link href="/" className="relative">
                  ...
                  <div className=" group overflow-hidden rounded-t-full">
                      ...
                      <Image src={cat2} className="h-52 md:h-100 ease-in-out group-hover:scale-105  transition-all duration-300 object-cover rounded-t-full" alt="Appetizers" />
                    </div>
                </Link>
                <Link href="/" className="text-center mt-4 space-y-2 md:space-y-3 px-1.5 md:px-8 block">
                  <p className="text-2xl md:text-3xl mt-6">Main Dishes</p>
              ...
              <div>
                <Link href="/" className="relative">
                  ...
                  <div className=" group overflow-hidden rounded-t-full">
                      ...
                      <Image src={cat3} className="h-52 md:h-100 ease-in-out group-hover:scale-105  transition-all duration-300 object-cover rounded-t-full" alt="Appetizers" />
                    </div>
                </Link>
                <Link href="/" className="text-center mt-4 space-y-2 md:space-y-3 px-1.5 md:px-8 block">
                  <p className="text-2xl md:text-3xl mt-6">Desserts</p>
          ...
          <div className=" bg-primary2">
            <div className="py-20 mx-auto px-4 max-w-300">
              ...
              <div className="rounded-2xl mt-8 bg-[url('/homepage/menu-bg-paper.jpg')] bg-cover bg-center bg-no-repeat">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-10 p-5 md:p-16 pt-8">
                    {
